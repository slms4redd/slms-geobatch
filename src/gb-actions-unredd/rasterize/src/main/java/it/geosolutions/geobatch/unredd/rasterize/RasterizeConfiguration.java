 ...
 * 
 */
public class RasterizeConfiguration extends ActionConfiguration implements Configuration {
    ...
    public RasterizeConfiguration clone() {
        final RasterizeConfiguration ret = new RasterizeConfiguration(this.getId(), this.getName(), this.getDescription());
